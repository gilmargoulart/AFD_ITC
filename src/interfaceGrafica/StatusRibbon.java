...
public class StatusRibbon implements GraphicalShape{
    ...
    public static final int WIDTH = MainProgram.CANVAS_WIDTH;
    private final MainProgram game;
    public StatusRibbon(MainProgram game) {
        this.game = game;
    }
    ...
    public void Paint(Graphics2D graphics) {
        ...
        Area background = new Area(new Rectangle(0, 0, MainProgram.CANVAS_WIDTH, HEIGHT));
