...
public class InvaderShip implements GraphicalShape, CollisionalShape, DynamicElement {
    ...
    public InvaderShip(int row, int column){
        Point location = new Point(
            column * MainProgram.INVADER_COLUMN_WIDTH +  MainProgram.INVADER_WINDOW_MARGIN_LEFT,
            row * MainProgram.INVADER_ROW_HEIGHT + MainProgram.INVADER_WINDOW_MARGIN_TOP);
    ...
    public void MoveToNextLine(){
        AffineTransform transform = new AffineTransform();
        transform.translate(0, MainProgram.INVADER_NEXT_LINE_HEIGHT);
        currentShape.transform(transform);
    }
